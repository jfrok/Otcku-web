...
<div class="p-3 shadow "> Manger :  </div>
<input class="form-control mb-1" type="text" name="nav" value="'.$sugg->nav.'" />
';
...
if(isset($_POST['update'])){
   ...
   // end
    $updateUser = $database->prepare("UPDATE sugg SET movie = :movie , series= :series , anime = :anime , manger = :manger , nav = :nav WHERE ID = :id");
    ...
    $updateUser->bindParam("nav",$_POST['nav']);  
