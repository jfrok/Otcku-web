    ...
    <div class="content-2">
        <div class="recent-payments">
            ...
            <table>
                ...
                $sqlUser =  "SELECT s.TV_NAME,e.NAME,e.ID,e.IMAGEURL,e.RATE,e.ADD_DATE,e.SID,EP_USER_ID FROM episodetv_info e INNER JOIN tvshow s ON e.SID = s.ID ORDER BY e.ID desc LIMIT 10 ";
