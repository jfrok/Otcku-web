...
if(isset($_GET['searchBtn'])){
    ...
    $searchResult = $database->prepare("SELECT * FROM tvshow WHERE NAME LIKE :name ");
...
if(isset($_GET['remove'])){
 $removeItems =  $database->prepare("DELETE FROM tvshow WHERE ID = :id");
 $removeItems->bindParam("id",$_GET['remove']);
 $removeItems->execute();

$removeUser = $database->prepare("DELETE FROM tvshow WHERE ID = :id");
