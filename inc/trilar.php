...
<main class="container mt-3" style="text-align: center; margin-top: 100px !important;">
    ...
    <div>
        ...
        if (isset($_GET['searchBtn']) and isset($_GET['search'])) {
            if ($_GET['search'] != "") {
                $searchResult = $database->prepare("SELECT * FROM movies_info WHERE NAME = :name");
       ...
       <div id='main-content'>
          ...
          <a href="./wm?search=' . $result['NAME'] . '&searchBtn=" class="btn btn-hover">
          <i class="bx bxs-right-arrow"></i>
            <span>Watch now</span>
                    ...
                    $sqlUser = "SELECT s.UR_NAME,s.ID,e.IMAGEURL,e.RATE,e.USER_ID FROM movies_info e INNER JOIN users s ON e.USER_ID = s.ID WHERE e.ID = " . $result['ID'] . "";
                    ...
                    if (mysqli_num_rows($results) > 0) {
                        ...
                        echo "<div class='user'>
                 Added By Admin <a href='#' class='neon-button'>" . $userName['UR_NAME'] . "
                  </a>
                  </div>";
                    }
        ...
        <div class="movie-item">
                <a href="trilar?search=' . $firstSlide['NAME'] . '&searchBtn=">  <img src=' . $firstSlide['IMAGEURL'] . '>
