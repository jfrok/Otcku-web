...
$numberOfResults = "SELECT * FROM movies_info ";
...
$resultsql = "SELECT * FROM movies_info LIMIT " . $resultsPerPage . " OFFSET " . ($page-1)*$resultsPerPage;
...
<div class="mimge">
  ...
  <div class="flm">    
  <a href="./db/trilar.php?search='.$result['ID']. '&searchBtn="</a>  <img src='.$result['IMAGEURL'] .'>    
